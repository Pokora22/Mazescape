...
//            animator.SetFloat("Forward", transform.InverseTransformDirection(m_RigidBody.velocity).z);
            float inputSign = Math.Sign(Input.GetAxis("Vertical"));
            float velocity = m_RigidBody.velocity.sqrMagnitude;
...
//turn back on next frame
            ...
            Physics.Raycast(transform.position, Vector3.down, out RaycastHit hit, 100f, (1 << LayerMask.NameToLayer("DirectionalLighting") | 1 << LayerMask.NameToLayer("Default")),
